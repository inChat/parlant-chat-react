...
export const Chatbot = ({route, sessionId, asPopup, popupButton, classNames = {}}: ChatProps): JSX.Element => {
  ...
  return (
    <>
      <QueryClientProvider client={queryClient}>
        {asPopup ? (
          <>
            <Button ref={buttonRef} onClick={() => setChatOpen(val => !val)} className={twMerge("bg-black rounded-full min-w-fit size-[50px] p-[10px] m-[10px]", classNames?.defaultPopupButton)}>
